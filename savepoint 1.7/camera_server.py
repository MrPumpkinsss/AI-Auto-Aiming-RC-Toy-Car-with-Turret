    ...
    def generate_frames(self):
        ...
        while True:
            try:
                ...
                indicator_size = 100
                indicator_top_right = (400 - 150, 10)
                overlay = frame.copy()
                ...
                if cpu_temp is not None:
                    cv2.putText(frame, f"CPU Temp: {cpu_temp:.2f}C", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.65, (0, 0, 255), 2)
    ...
    def handle_motor(self, data):
        ...
        if data == "AIM":
            ...
            if data[0] == "L":
                ...
                self.gimbal_x = max(0, min(270, self.gimbal_x - int(x / 10)))  # Scale x-axis input
